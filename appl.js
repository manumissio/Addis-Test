...
function ideaFeed() {
	...
	$.ajax({
		...
		var ideatest = console.log('ideas count again ' + ideas.length);
...
$('#registerModal #registerBTN').click(function(event) {
	...
	console.log($('#registerModal #reg-username').val(), $('#registerModal #reg-email').val(), $('#registerModal #reg-password').val(), name.fn, name.ln, $('#registerModal #reg-referral').val());
	$("button").replaceWith("<p>Complete!</p>");
